...
# RUN mkdir -p /project/train/src_repo2 && mkdir -p /project/train/result-graphs && mkdir -p /project/train/log && mkdir -p /project/train/models2

# 安装训练环境依赖端软件，请根据实际情况编写自己的代码
COPY ./ /project/train/src_repo/
# COPY ./ /project/train/src_repo2/
